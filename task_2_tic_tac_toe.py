...
board_cell = Back.YELLOW + ' ' + Style.RESET_ALL
board = [[board_cell for i in range(3)] for j in range(3)]
player = Fore.RED + 'X' + Style.RESET_ALL
...
def ask_move(player, board):
    ...
    if (0 <= x <= 2) and (0 <= y <= 2) and (board[x][y] == board_cell):
